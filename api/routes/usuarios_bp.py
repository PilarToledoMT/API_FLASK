...
usuarios_bp.route("/usuarios/<int:id_usuario>", methods=["PUT"])(UsuarioController.update_usuario)
usuarios_bp.route("/usuarios/<int:id_usuario>", methods=["DELETE"])(UsuarioController.delete_usuario)
usuarios_bp.route("/login", methods = ['GET', 'POST'])(UsuarioController.login)